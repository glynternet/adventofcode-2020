...
parseRuleStr : String -> Result String ( Int, Int )
parseRuleStr str =
    case String.split "-" str of
        [ start, end ] ->
            case String.toInt start of
                Nothing ->
                    Err "Couldn't parse start to int"

                Just s ->
                    case String.toInt end of
                        Nothing ->
                            Err "Couldn't parse end to int"
...
inputTest =
    ( parseRulesStr """class: 1-3 or 5-7
row: 6-11 or 33-44
seat: 13-40 or 45-50"""
    , [ 7, 1, 14 ]
    , [ [ 7, 3, 47 ]
...
inputReal : InputModel
inputReal =
    ( parseRulesStr """departure location: 44-401 or 415-965
